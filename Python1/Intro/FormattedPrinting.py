# Fancy tricks with print statements

print("This prints a string, filling in variable name for %s.")
name = "Jill"
print("hello %s." % (name))

print("\nThis does the same thing, but makes sure the name is exactly 10 spaces wide.")
name = "Jill"
...
print("\nThis prints two integers, making them exactly 2 spaces each.")
i = 5
j = 15
print("%2d" % (i))
print("%2d" % (j))
